...
Citizen.CreateThread(function()
	...
	while ESX.GetPlayerData().job2 == nil do --TrewUi Double setjob2 by ademo !
		Citizen.Wait(10) 
	end
...
AddEventHandler('trew_hud_ui:setInfo', function(info)
	...
	SendNUIMessage({ action = 'setText', id = 'job2', value = info['job2'] }) --TrewUi Double job2 by ademo !
	...
	if ESX.PlayerData.job2 ~= nil then --TrewUi Double job2 by ademo !
		if ESX.PlayerData.job2.grade_name ~= nil and ESX.PlayerData.job2.grade_name == 'boss' then --TrewUi Double job2 by ademo !
			if (Config.ui.showSocietyMoney == true) then
				SendNUIMessage({ action = 'element', task = 'enable', value = 'society' })
			end
			ESX.TriggerServerCallback('esx_society:getSocietyMoney', function(money)
...
RegisterCommand('toggleui', function()
	if not toggleui then
		...
		SendNUIMessage({ action = 'element', task = 'disable', value = 'job2' }) --TrewUi Double job2 by ademo !
		SendNUIMessage({ action = 'element', task = 'disable', value = 'society' })
		...
		if (Config.ui.showJob2 == true) then
			SendNUIMessage({ action = 'element', task = 'enable', value = 'job2' }) --TrewUi Double job2 by ademo !
		end
		if (Config.ui.showSocietyMoney == true) then
			SendNUIMessage({ action = 'element', task = 'enable', value = 'society' })
		end
